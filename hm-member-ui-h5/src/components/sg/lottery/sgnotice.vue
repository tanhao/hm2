<template>
  <div>
    <div class="home" v-show="!noticeShow" >
      <div class="sc-bZQynM OQRyf">
        <div class="sc-gzVnrw flXAPw">
          <my-header maintop="true" userxy="true"></my-header>
            ...
            <div class="win_info">
              <ul class="decimal">
                ...
                <li>我瞭解以及同意下註列明的協定和規則。</li>
                  <div style="width: 100%;text-align: center;padding-top: 20px;" @click="onOk"><span class="btn btn-success">同意</span></div>
              </ul>
            </div>
          </div>
        </div>
