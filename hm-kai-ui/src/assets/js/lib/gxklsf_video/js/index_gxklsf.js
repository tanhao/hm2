$(function() {
	...
	document.addEventListener('click', function() {
		if($("iframe")[0].contentWindow.ifopen) {
			$("iframe")[0].contentWindow.gxklsf.sound.play("audioidKai");
			$("iframe")[0].contentWindow.gxklsf.sound.play("audioidBg");
...
method.listData = function(date) {
		$.ajax({
			url: config.publicUrl + "gxklsf/getHistoryLotteryInfo.do?date=" + date,
			type: "GET",
			data: {
				"lotCode": lotCode
			},
...
method.todayData = function(date) {
		$.ajax({
			url: config.publicUrl + "gxklsf/getKlsfDoubleCount.do?date=" + date,
			type: "GET",
			data: {
				"lotCode": lotCode
			},
...
method.longData = function(date) {
	$.ajax({
		url: config.publicUrl + "gxklsf/getKlsfLongDragonCount.do?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
