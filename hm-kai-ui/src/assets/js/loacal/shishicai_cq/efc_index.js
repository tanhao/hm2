...
function listData() {
	$.ajax({
		url: "/news/index.php?m=index&c=index&a=kaijiang&type=getBaseCQShiCaiList",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function todayData() {
	$.ajax({
		url: "/news/index.php?m=index&c=index&a=kaijiang&type=queryDoubleNumber",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function longData() {
	$.ajax({
		url: "/news/index.php?m=index&c=index&a=kaijiang&type=getShiCaiDailyDragonCount",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
