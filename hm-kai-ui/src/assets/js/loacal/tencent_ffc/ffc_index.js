$(function() {
    ...
    $('#datebox').calendar({
        ...
        onSelected: function(view, date, data) {
            ...
            if(fundate[1] * 1 <= 9) {
                datE = fundate[0] + "-" + "0" + fundate[1] * 1 + "-" + fundate[2]
            } else {
                datE = date
            }
            listData(datE);
...
function createHtmlList(jsondata) {
    ...
    $("#jrsmhmtj>table").html('<tr><th width="135">时间</th><th width="130">期数</th><th id="numberbtn" width="29%" class="numberbtn"><span id="xshm" class="spanselect">显示号码</span><span id="xsdx">显示大小</span><span id="xsds">显示单双</span></th><th colspan="3" width="18%">总和</th><th colspan="" width="60">前三</th><th colspan="" width="60">中三</th><th colspan="" width="60">后三</th></tr>');
    $(data).each(function(index) {
        ...
        if(!(preDrawCode.length <= 1)) {
            ...
            var style14 = (behindThree == "顺子") ? stylestr + "#f12d35'" : "'";
            var betweenThree = (typeOf('san', this.betweenThree)); //中三
            var style15 = (betweenThree == "顺子") ? stylestr + "#f12d35'" : "'";
            var lastThree = (typeOf('san', this.lastThree)); //后三
            var style16 = (lastThree == "顺子") ? stylestr + "#f12d35'" : "'";
        ...
        var last = "<td>" + this.sumNum + "</td><td " + style1 + ">" + sumSingleDouble + "</td><td " + style2 + ">" + sumBigSmall + "</td><td " + style14 + ">" + behindThree + "</td><td " + style15 + ">" + betweenThree + "</td><td " + style16 + ">" + lastThree + "</td>";
