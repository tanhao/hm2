$(function() {
	$("#headdivbox").load("/html/public/head.html?v=20187121149", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
	$("#fooderbox").load("/html/public/fooder.html?v=20187121149", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
...
indexObj.ajaxSsc = function(issue, id) {
	...
	var iferror = false;
	$.ajax({
		url: urlbublic + "klsf/getLotteryInfo.do?issue=" + issue,
		type: "GET",
		data: {
			"lotCode":lotCode
		},
