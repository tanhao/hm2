...
function listData() {
	$.ajax({
		url: '/news/index.php?m=api&c=xyft&a=getPksHistoryList',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function todayData() {
	$.ajax({
		url: '/news/index.php?m=api&c=xyft&a=getPksDoubleCount',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function longData() {
	$.ajax({
		url: '/news/index.php?m=api&c=xyft&a=getPksLongDragonCount',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
