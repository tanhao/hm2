...
function listData() {
	$.ajax({
		url: '/news/index.php?m=index&c=index&a=kaijiang&type=getPksHistoryList&loteCode=sfsc',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function todayData() {
	$.ajax({
		url: '/news/index.php?m=index&c=index&a=kaijiang&type=getPksDoubleCount&loteCode=sfsc',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function longData() {
	$.ajax({
		url: '/news/index.php?m=index&c=index&a=kaijiang&type=getPksLongDragonCount&loteCode=sfsc',
		type: "GET",
		data: {
			"lotCode":lotCode
		},
